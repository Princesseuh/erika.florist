...
<Image
  src={import("./epicdsl.png")}
  alt="Screenshot of an imaginary language showing a lot of red squigglies"
  caption="Don't mind the red squigglies, I'm just waiting for Microsoft to add native support inside VS Code for me!"
/>
...
<Image
  src={import("./responsedoc.png")}
  alt="Shows the hover info for Astro.request, showing hyperlinks and a snippet of code with syntax coloring"
  caption="Modern editors even allows you to use Markdown in your hover info! Abuse it!"
/>
...
<Image
  src={import("./rust-clippy.png")}
  alt="Shows a lint example from Clippy directly in the user's editor"
  caption="The rendering of the actual message isn't amazing, but Clippy and Rust-Analyzer definitely makes for a very nice editing experience"
/>
