...
[As Oil describe it, there's two type of shell users: the people who just type commands and the people who write long scripts.](http://www.oilshell.org/blog/2021/01/why-a-new-shell.html#how-is-oil-different-than-bash-or-zsh)

On that spectrum, I'd say that I am much closer to the casual user than the power user. I know *how* to write scripts, but I: generally don't need to, and more importantly, don't *want* to. As such, the shells that I find interesting are definitely mostly the one that cater to the more casual users. Elvish having a built-in file manager is a great example of that, for instance.

Notably, this means that shells like [PowerShell](https://docs.microsoft.com/en-us/powershell/) or [Oil](https://www.oilshell.org/) don't get much more of a "Huh, that's cool" reaction from me.
