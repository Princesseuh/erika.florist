...
I know _how_ to write scripts, but I: generally don't need to, and more importantly, don't _want_ to. As such, the shells that I find interesting are definitely mostly the one that cater to the command-typers. [Elvish](https://elv.sh/) having a built-in file manager is a great example of that, for instance.
