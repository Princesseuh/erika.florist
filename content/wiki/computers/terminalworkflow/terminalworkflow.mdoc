...
[For an exhaustive list, please check my `dotfiles`](https://github.com/Princesseuh/dotfiles/blob/main/shared/fish/abbr.fish). Notably, there's a lot of Git abbreviations that are pretty neat and that I use often.
...
For this, I use two things: [`walk`](https://github.com/antonmedv/walk) and [`zoxide`](https://github.com/ajeetdsouza/zoxide). I tend to use the former whenever I'm browsing files, and the latter when I actually know where I want to go (and I've been there before.)

For `walk`, there's a lot of way more powerful options out there ([`ranger`](https://github.com/ranger/ranger) is a good one), but I really wanted something simple. Only problem is that the keybinds are not necessarily amazing depending on your keyboard layout, but apart from that it's usable very easily out of the box.
