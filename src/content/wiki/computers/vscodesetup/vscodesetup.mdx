...
<Image
	src={import("./screenshot.png")}
	alt="Screenshot of my VS Code setup, the color scheme is dark, the sidebar is on the right"
	caption="My setup is pretty classic so don't expect anything too crazy. Some newly added settings might be missing from this particular screenshot"
/>
